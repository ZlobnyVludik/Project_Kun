...
Label(title_frame, text="Sign Up", bg="#e6a817", fg="Yellow", font="Arial 13 bold").pack(side=LEFT, padx=10, pady=8)
...
Radiobutton(gender_frame, text="Male", variable=gender_var, value="Male", bg="#1e2233", fg="#e6a817",
            selectcolor="#1e2233", font="Arial 10").pack(side=LEFT)
Radiobutton(gender_frame, text="Female", variable=gender_var, value="Female", bg="#1e2233", fg="#e6a817",
            selectcolor="#1e2233", font="Arial 10").pack(side=LEFT)
...
agree_var = IntVar()
Checkbutton(agree_frame, text="I agree to the Terms of Use", variable=agree_var, bg="#1e2233", fg="#e6a817",
...
Button(bottom_frame, text="submit", bg="#4cae4c", fg="white", font="Arial 10 bold", bd=0,
       padx=10).pack(side=RIGHT, padx=(0, 5), pady=10)
Button(bottom_frame, text="Cancel", bg="#d9534f", fg="white", font="Arial 10 bold", bd=0,
       padx=10).pack(side=RIGHT, padx=5, pady=10)
