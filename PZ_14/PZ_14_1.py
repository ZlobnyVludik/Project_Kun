...
Label(text="Sign Up", font=("Arial", 16)).grid(row=0, column=0, columnspan=2, pady=10)

Label(text="First Name").grid(row=1, column=0, sticky="e")
Entry().grid(row=1, column=1, padx=5, pady=2)

Label(text="Last Name").grid(row=2, column=0, sticky="e")
Entry().grid(row=2, column=1, padx=5, pady=2)

Label(text="Screen Name").grid(row=3, column=0, sticky="e")
Entry().grid(row=3, column=1, padx=5, pady=2)

Label(text="Date of Birth").grid(row=4, column=0, sticky="e")
frame_dob = Frame()
...
Label(text="Gender").grid(row=5, column=0, sticky="e")
frame_gender = Frame()
...
Label(text="Country").grid(row=6, column=0, sticky="e")
...
Label(text="E-mail").grid(row=7, column=0, sticky="e")
Entry().grid(row=7, column=1, padx=5, pady=2)

Label(text="Phone").grid(row=8, column=0, sticky="e")
Entry().grid(row=8, column=1, padx=5, pady=2)

Label(text="Password").grid(row=9, column=0, sticky="e")
Entry(show="*").grid(row=9, column=1, padx=5, pady=2)

Label(text="Confirm Password").grid(row=10, column=0, sticky="e")
Entry(show="*").grid(row=10, column=1, padx=5, pady=2)

agree_var = IntVar()
Checkbutton(text="I agree to the Terms of Use", variable=agree_var).grid(row=11, column=0, columnspan=2, pady=5)
